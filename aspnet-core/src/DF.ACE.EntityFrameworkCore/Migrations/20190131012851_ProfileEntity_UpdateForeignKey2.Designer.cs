...
namespace DF.ACE.Migrations
{
    ...
    [Migration("20190131012851_ProfileEntity_UpdateForeignKey2")]
    partial class ProfileEntity_UpdateForeignKey2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DF.ACE.Authorization.Users.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ACE_UserProfiles");
                });

            modelBuilder.Entity("DF.ACE.Common.Attachment.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DF.ACE.Common.Attachment.Demo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DF.ACE.Common.Attachment.ProfileAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DF.ACE.Navigation.NavigationMenuItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("ParentNavigationMenuItemId");
                    ...
                    b.ToTable("ACE_NavigationMenuItems");
                });
            ...
            modelBuilder.Entity("DF.ACE.Authorization.Users.UserProfile", b =>
                {
                    b.HasOne("DF.ACE.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("DF.ACE.Navigation.NavigationMenuItem", b =>
                {
                    b.HasOne("DF.ACE.Navigation.NavigationMenuItem", "Parent")
                        .WithMany("Children")
